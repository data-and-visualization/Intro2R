...
Take the [interactive quiz](https://libjohn.shinyapps.io/intro2r-assignments2/)


## Directions

Now you try.  You data should already be loaded.  (Look in the Environment tab. If there are no variables, you'll have to rerun exercise one.)  In this exercise you'll practice the `dplyr` verbs mentioned in the lecture:
...
See [the answers](answers.html#part_two:_data_management) to the above section