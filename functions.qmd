...
If you have to write the same code three times or more, write a function. Among the advantages, this prevents typographical errors. It also prevents mistakes when updating code because there will be fewer places to update code leverages functions and iteration over redundancy.
:::
