...
*Load the file into a new variable called `broadhead`?*

- The data are in a *CSV* file on your local workstation which needs to be loaded into R.  The data file is in a directory relative to your Rmd script: `data/broadhead.csv`.
...
```{r read_csv-solution}
broadhead <- read_csv("data/broadhead.csv")
...
```{r datastruct}
quiz(
  question("What function will tell you the data type for the 'menuItem' variable inside the broadhead tibble?",
    answer("glimpse(broadhead$menuItem)"),
    answer("tbl_vars(broadhead)"),
    answer("class(broadhead$menuItem)", correct = TRUE),
    answer("str(broadhead)")
  ),
  
  question("The data structure for broadhead is?",
...
Take a look at the structure of the `broadhead` variable.
...
quiz(
    question("What is the best command to concisely learn more about the variables, observations, and data types within a Tibble",
             answer("class(broadhead)"),
             answer("glimpse(broadhead)", correct = TRUE),
             answer("tbl_vars(broadhead)"),
             answer("str(broadhead)", message = "This works but is not a conscise report"),
             answer("broadhead", message = "This will work but require a lot of mouse-clicking on your part")
           ),
