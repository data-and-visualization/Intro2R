...
repository <- "https://bitbucket.org/libjohn/intro2r"
preamble2 <- "Repository for this document:"
repository <- paste(preamble2, repository, sep = " ")
repository
```
...
* `readxl`  
    * **Note:** There are several differen read-excel-file packages
