...
[^2]: There is no mandate to join the twenty-first century and honor academic values like *reproducibility, such as* rendering reports from code. You do you. I don't judge 😃
