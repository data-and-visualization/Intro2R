...
[`geom_col`](https://ggplot2.tidyverse.org/reference/geom_bar.html) - use this geom_ when bar heights are already represent in the dataframe and should be displayed as the values represented.
