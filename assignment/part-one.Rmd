...
- One option is to use the *Import Dataset* feature of RStudio from the *File* menubar. Code will be generated for you, which you can run immediately, or look to the bottom of the dialogue box and capture the code to run in your code chunk.
