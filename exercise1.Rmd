...
Take the [interactive quiz](https://libjohn.shinyapps.io/intro2r_quizzes/)
...
1. Reading the preloaded directions in your new script, add a code chunk at line 18.  (Hint: *Ctrl+Alt+I*)
...
1. Using what we've you've seen in class, if `data/brodheadCenter.csv` is a csv file, how would you load the file into a new variable called `brodhead`?

2. What data type is `brodhead`?
